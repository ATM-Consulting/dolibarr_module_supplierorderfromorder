...
print $form->selectyesno("SOFO_CREATE_NEW_SUPPLIER_ODER_ANY_TIME",getDolGlobalString('SOFO_CREATE_NEW_SUPPLIER_ODER_ANY_TIME')?$conf->global->SOFO_CREATE_NEW_SUPPLIER_ODER_ANY_TIME:'',1);
...
print $form->selectyesno("SUPPORDERFROMORDER_USE_ORDER_DESC",getDolGlobalString('SUPPORDERFROMORDER_USE_ORDER_DESC')?$conf->global->SUPPORDERFROMORDER_USE_ORDER_DESC:'',1);
print '<input type="submit" class="button" value="'.$langs->trans("Modify").'">';
print '</form>';
print '</td></tr>';
...
print $form->selectyesno("SOFO_ADD_FREE_LINES",getDolGlobalString('SOFO_ADD_FREE_LINES')?$conf->global->SOFO_ADD_FREE_LINES:'',1);
print '<input type="submit" class="button" value="'.$langs->trans("Modify").'">';
print '</form>';
print '</td></tr>';
...
if (getDolGlobalString('SOFO_ADD_FREE_LINES')) {
	...
	print $form->selectyesno("SOFO_COST_PRICE_AS_BUYING",getDolGlobalString('SOFO_COST_PRICE_AS_BUYING')?$conf->global->SOFO_COST_PRICE_AS_BUYING:'',1);
	print '<input type="submit" class="button" value="'.$langs->trans("Modify").'">';
	print '</form>';
	print '</td></tr>';
}
...
print $form->selectyesno("SOFO_DISTINCT_ORDER_BY_PROJECT",getDolGlobalString('SOFO_DISTINCT_ORDER_BY_PROJECT')?$conf->global->SOFO_DISTINCT_ORDER_BY_PROJECT:'',1);
print '<input type="submit" class="button" value="'.$langs->trans("Modify").'">';
print '</form>';
print '</td></tr>';
...
print $form->selectyesno("SUPPLIERORDER_FROM_ORDER_CONTACT_DELIVERY",getDolGlobalString('SUPPLIERORDER_FROM_ORDER_CONTACT_DELIVERY')?$conf->global->SUPPLIERORDER_FROM_ORDER_CONTACT_DELIVERY:'',1);
print '<input type="submit" class="button" value="'.$langs->trans("Modify").'">';
print '</form>';
print '</td></tr>';
...
print $form->selectyesno("SUPPLIERORDER_FROM_ORDER_HEADER_SUPPLIER_ORDER",getDolGlobalString('SUPPLIERORDER_FROM_ORDER_HEADER_SUPPLIER_ORDER')?$conf->global->SUPPLIERORDER_FROM_ORDER_HEADER_SUPPLIER_ORDER:'',1);
print '<input type="submit" class="button" value="'.$langs->trans("Modify").'">';
print '</form>';
print '</td></tr>';
...
print $form->selectyesno("SOFO_USE_DELIVERY_TIME",getDolGlobalString('SOFO_USE_DELIVERY_TIME')?$conf->global->SOFO_USE_DELIVERY_TIME:'',1);
print '<input type="submit" class="button" value="'.$langs->trans("Modify").'">';
print '</form>';
print '</td></tr>';
...
print $form->selectyesno("SOFO_USE_VIRTUAL_ORDER_STOCK",getDolGlobalString('SOFO_USE_VIRTUAL_ORDER_STOCK')?$conf->global->SOFO_USE_VIRTUAL_ORDER_STOCK:'',1);
print '<input type="submit" class="button" value="'.$langs->trans("Modify").'">';
print '</form>';
print '</td></tr>';
...
print $form->selectyesno("SOFO_USE_ONLY_OF_FOR_NEEDED_PRODUCT",getDolGlobalString('SOFO_USE_ONLY_OF_FOR_NEEDED_PRODUCT')?$conf->global->SOFO_USE_ONLY_OF_FOR_NEEDED_PRODUCT:'',1);
print '<input type="submit" class="button" value="'.$langs->trans("Modify").'">';
print '</form>';
print '</td></tr>';
...
print $form->selectyesno("SOFO_DO_NOT_USE_CUSTOMER_ORDER",getDolGlobalString('SOFO_DO_NOT_USE_CUSTOMER_ORDER')?$conf->global->SOFO_DO_NOT_USE_CUSTOMER_ORDER:'',1);
print '<input type="submit" class="button" value="'.$langs->trans("Modify").'">';
print '</form>';
print '</td></tr>';
...
print $form->selectyesno("SOFO_GET_INFOS_FROM_FOURN",getDolGlobalString('SOFO_GET_INFOS_FROM_FOURN')?$conf->global->SOFO_GET_INFOS_FROM_FOURN:'',1);
print '<input type="submit" class="button" value="'.$langs->trans("Modify").'">';
print '</form>';
print '</td></tr>';
...
print $form->selectyesno("SOFO_USE_MAX_DELIVERY_DATE",getDolGlobalString('SOFO_USE_MAX_DELIVERY_DATE')?$conf->global->SOFO_USE_MAX_DELIVERY_DATE:'',1);
print '<input type="submit" class="button" value="'.$langs->trans("Modify").'">';
print '</form>';
print '</td></tr>';
...
print $form->selectyesno("SOFO_DISPLAY_SERVICES",getDolGlobalString('SOFO_DISPLAY_SERVICES')?$conf->global->SOFO_DISPLAY_SERVICES:'',1);
print '<input type="submit" class="button" value="'.$langs->trans("Modify").'">';
print '</form>';
print '</td></tr>';
...
print $form->selectyesno("INCLUDE_PRODUCT_LINES_WITH_ADEQUATE_STOCK",getDolGlobalString('INCLUDE_PRODUCT_LINES_WITH_ADEQUATE_STOCK')?$conf->global->INCLUDE_PRODUCT_LINES_WITH_ADEQUATE_STOCK:'',1);
print '<input type="submit" class="button" value="'.$langs->trans("Modify").'">';
print '</form>';
print '</td></tr>';
...
print $form->selectyesno('SOFO_PRESELECT_SUPPLIER_PRICE_FROM_LINE_BUY_PRICE', getDolGlobalString('SOFO_PRESELECT_SUPPLIER_PRICE_FROM_LINE_BUY_PRICE')?$conf->global->SOFO_PRESELECT_SUPPLIER_PRICE_FROM_LINE_BUY_PRICE:'',1);
print '<input type="submit" class="button" value="'.$langs->trans("Modify").'">';
print '</form>';
print '</td></tr>';
...
$var=!$var;
print '<tr '.$bc[$var].'>';
print '<td>'.$langs->trans('SOFO_QTY_LINES_COMES_FROM_ORIGIN_ORDER_ONLY').'</td>';
print '<td align="center" width="20">&nbsp;</td>';
print '<td align="right" width="300">';
print '<form method="POST" action="'.$_SERVER['PHP_SELF'].'">';
print '<input type="hidden" name="token" value="'.$newToken.'">';
print '<input type="hidden" name="action" value="set_SOFO_QTY_LINES_COMES_FROM_ORIGIN_ORDER_ONLY">';
print $form->selectyesno('SOFO_QTY_LINES_COMES_FROM_ORIGIN_ORDER_ONLY', getDolGlobalString('SOFO_QTY_LINES_COMES_FROM_ORIGIN_ORDER_ONLY')?$conf->global->SOFO_QTY_LINES_COMES_FROM_ORIGIN_ORDER_ONLY:'',1);
print '<input type="submit" class="button" value="'.$langs->trans("Modify").'">';
print '</form>';
print '</td></tr>';
...
print $form->selectyesno('SOFO_GROUP_LINES_BY_PRODUCT', getDolGlobalString('SOFO_GROUP_LINES_BY_PRODUCT')?$conf->global->SOFO_GROUP_LINES_BY_PRODUCT:'',1);
print '<input type="submit" class="button" value="'.$langs->trans("Modify").'">';
print '</form>';
print '</td></tr>';
...
if(getDolGlobalString('PRODUIT_SOUSPRODUITS')) {
	...
	print $form->selectyesno("SOFO_VIRTUAL_PRODUCTS", getDolGlobalString('SOFO_VIRTUAL_PRODUCTS')?$conf->global->SOFO_VIRTUAL_PRODUCTS:'', 1);
	print '<input type="submit" class="button" value="' . $langs->trans("Modify") . '">';
	print '</form>';
	print '</td></tr>';
}
...
if (!empty($conf->multicompany->enabled) && getDolGlobalString('MULTICOMPANY_STOCK_SHARING_ENABLED')) {
	...
	print $form->selectyesno('SOFO_CHECK_STOCK_ON_SHARED_STOCK', getDolGlobalString('SOFO_CHECK_STOCK_ON_SHARED_STOCK')?$conf->global->SOFO_CHECK_STOCK_ON_SHARED_STOCK:'', 1);
	print '<input type="submit" class="button" value="' . $langs->trans("Modify") . '">';
	print '</form>';
	print '</td></tr>';
}
...
if(! empty($conf->categorie->enabled)) {
	...
	print getCatMultiselect("SOFO_DEFAULT_PRODUCT_CATEGORY_FILTER", getDolGlobalString('SOFO_DEFAULT_PRODUCT_CATEGORY_FILTER') ? unserialize($conf->global->SOFO_DEFAULT_PRODUCT_CATEGORY_FILTER) : array(-1));
