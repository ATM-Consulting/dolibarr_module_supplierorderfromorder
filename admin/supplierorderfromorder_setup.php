...
print $form->selectyesno("SUPPLIERORDER_FROM_ORDER_NOTES_PUBLIC", getDolGlobalString('SUPPLIERORDER_FROM_ORDER_NOTES_PUBLIC'),1);
print '<input type="submit" class="button" value="'.$langs->trans("Modify").'">';
print '</form>';
print '</td></tr>';
...
print $form->selectyesno("SUPPLIERORDER_FROM_ORDER_HEADER_SUPPLIER_ORDER",getDolGlobalInt('SUPPLIERORDER_FROM_ORDER_HEADER_SUPPLIER_ORDER'),1);
print '<input type="submit" class="button" value="'.$langs->trans("Modify").'">';
print '</form>';
print '</td></tr>';
